  ...
  return (
    <>
      <div className={`${label && "mt-2"} w-full`}>
        ...
        {isTextArea ? (
          <textarea
            className={`w-full rounded border border-gray-300 bg-white px-3 py-2 text-sm transition-colors focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 ${showError &&
