  ...
  return (
    <div className="relative">
      <input
        ...
        type={type}
        value={value}
        className={`text-sm border w-full focus:border-primary/30 transition-colors ease-in-out duration-300 outline-none rounded ${isSearchable ? "pl-6 pr-2" : "px-2"
          } py-2 ${className}`}
      />
      {isSearchable && (
        <svg
          className="absolute top-3.25 left-2"
          width="12"
          height="12"
          viewBox="0 0 12 12"
          fill="none"
